...
class TestModelPredicatePipes(WRApp.TestCase):
    ...
    def test_StepIntervalPredicate(self) -> None:
        ...
        predicate = WRApp.StepIntervalPredicate(parameters)
    ...
    def test_PeriodicTimeIntervalPredicate(self) -> None:
        ...
        predicate = WRApp.PeriodicTimeIntervalPredicate(parameters)
    ...
    def test_PeriodicStepIntervalPredicate(self) -> None:
        ...
        predicate = WRApp.PeriodicStepIntervalPredicate(parameters)
