...
void TestEntityProxy(TContainer& rEntities)
{
    ...
    for (const auto& r_entity : r_immutable_entities) {
        ...
        auto proxy = WRApp::MakeProxy<TLocation>(r_entity);
...
KRATOS_TEST_CASE_IN_SUITE(ProcessInfoProxy_, KratosWRApplicationTestSuite)
{
    ...
    {
        auto proxy = WRApp::MakeProxy<Globals::DataLocation::ProcessInfo>(r_immutable_model_part.GetProcessInfo());
    ...
    {
        auto proxy = WRApp::MakeProxy<Globals::DataLocation::ProcessInfo>(r_mutable_model_part.GetProcessInfo());
    ...
    {
        auto proxy = WRApp::MakeProxy<Globals::DataLocation::ProcessInfo>(r_immutable_model_part);
    ...
    {
        auto proxy = WRApp::MakeProxy<Globals::DataLocation::ProcessInfo>(r_mutable_model_part);
...
KRATOS_TEST_CASE_IN_SUITE(ModelPartProxy_, KratosWRApplicationTestSuite)
{
    ...
    {
        auto proxy = WRApp::MakeProxy<Globals::DataLocation::ModelPart>(r_immutable_model_part);
    ...
    {
        auto proxy = WRApp::MakeProxy<Globals::DataLocation::ModelPart>(r_mutable_model_part);
...
KRATOS_TEST_CASE_IN_SUITE(HistoricalNodeContainerProxy_, KratosWRApplicationTestSuite)
{
    ...
    TestContainerProxy(WRApp::MakeProxy<Globals::DataLocation::NodeHistorical>(r_model_part),
                       WRApp::MakeProxy<Globals::DataLocation::NodeHistorical>(r_immutable_model_part));
}
...
KRATOS_TEST_CASE_IN_SUITE(NonHistoricalNodeContainerProxy_, KratosWRApplicationTestSuite)
{
    ...
    ModelPart& r_model_part = p_model->GetModelPart("root");
    const ModelPart& r_immutable_model_part = r_model_part;
    TestContainerProxy(WRApp::MakeProxy<Globals::DataLocation::NodeNonHistorical>(r_model_part),
                       WRApp::MakeProxy<Globals::DataLocation::NodeNonHistorical>(r_immutable_model_part));
}
...
KRATOS_TEST_CASE_IN_SUITE(ElementContainerProxy_, KratosWRApplicationTestSuite)
{
    ...
    ModelPart& r_model_part = p_model->GetModelPart("root");
    const ModelPart& r_immutable_model_part = r_model_part;
    TestContainerProxy(WRApp::MakeProxy<Globals::DataLocation::Element>(r_model_part),
                       WRApp::MakeProxy<Globals::DataLocation::Element>(r_immutable_model_part));
}
...
KRATOS_TEST_CASE_IN_SUITE(ConditionContainerProxy_, KratosWRApplicationTestSuite)
{
    ...
    ModelPart& r_model_part = p_model->GetModelPart("root");
    const ModelPart& r_immutable_model_part = r_model_part;
    TestContainerProxy(WRApp::MakeProxy<Globals::DataLocation::Condition>(r_model_part),
                       WRApp::MakeProxy<Globals::DataLocation::Condition>(r_immutable_model_part));
}
