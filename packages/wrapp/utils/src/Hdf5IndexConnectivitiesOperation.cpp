...
namespace {
void FillIdMap(
    Ref<const HDF5::File::Vector<int>> rIds,
...
void Hdf5IndexConnectivitiesOperation::Execute() {
    KRATOS_TRY
        ...
        HDF5::File::Vector<int> node_id_map;
        {
            ...
            const std::size_t max_id = IndexPartition<std::size_t>(node_ids.size()).for_each<MaxReduction<std::size_t>>(
