...
class ContainerProxy(WRApp.WRAppClass):
    ...
    def __init__(self,
        ...
        self.__container: typing.Union[KratosMultiphysics.NodesArray,
                                       KratosMultiphysics.ElementsArray,
                                       KratosMultiphysics.ConditionsArray]
    ...
    class Iterator:
        ...
        def __init__(self,
                     data_location: KratosMultiphysics.Globals.DataLocation,
                     container: typing.Union[KratosMultiphysics.NodesArray,
                                             KratosMultiphysics.ElementsArray,
                                             KratosMultiphysics.ConditionsArray]):
            self.__data_location = data_location
